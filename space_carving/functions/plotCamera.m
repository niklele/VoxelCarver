function plotCameras(ax,camera)
%PLOTCAMERA: draw a schematic of a camera
%
%   PLOTCAMERA(CAMERA) draws a camera on the current axes
%
%   PLOTCAMERA(AXES,CAMERA) draws a camera on the specified axes
